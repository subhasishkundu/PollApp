...
func (_c *VoteCreate) SetPollID(v int) *VoteCreate {
	_c.mutation.SetPollID(v)
	return _c
}

// SetPollOptionID sets the "poll_option_id" field.
func (_c *VoteCreate) SetPollOptionID(v int) *VoteCreate {
	_c.mutation.SetPollOptionID(v)
	return _c
}

// SetUserID sets the "user_id" field.
func (_c *VoteCreate) SetUserID(v int) *VoteCreate {
...
func (_c *VoteCreate) SetPollOption(v *PollOption) *VoteCreate {
	return _c.SetPollOptionID(v.ID)
}
...
func (_c *VoteCreate) check() error {
	...
	if _, ok := _c.mutation.PollOptionID(); !ok {
		return &ValidationError{Name: "poll_option_id", err: errors.New(`ent: missing required field "Vote.poll_option_id"`)}
	}
	...
	if len(_c.mutation.PollOptionIDs()) == 0 {
		return &ValidationError{Name: "poll_option", err: errors.New(`ent: missing required edge "Vote.poll_option"`)}
	}
...
func (_c *VoteCreate) createSpec() (*Vote, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.PollOptionIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
